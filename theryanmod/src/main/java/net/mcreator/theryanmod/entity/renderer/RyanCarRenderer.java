...
import net.mcreator.theryanmod.entity.RyanCarEntity;

@OnlyIn(Dist.CLIENT)
public class RyanCarRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(RyanCarEntity.entity, renderManager -> {
